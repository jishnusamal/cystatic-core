"""GitHub renderer for OperationalChangeModel.
...
class GitHubRenderer:
    ...
    def _prepare_render_data(self, ocm: OperationalChangeModel) -> dict[str, Any]:
        ...
        data["change"] = {
            ...
            "added_symbols": [self._render_symbol(s.symbol) for s in ocm.change.added_symbols],
            "removed_symbols": [self._render_symbol(s.symbol) for s in ocm.change.removed_symbols],
            "modified_symbols": [
                {
