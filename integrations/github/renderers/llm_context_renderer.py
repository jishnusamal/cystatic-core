...
class LLMContextRenderer:
    ...
    def render(self, artifact: EngineeringDiscoveryModel, settings: Any = None) -> dict[str, Any]:
        """
    ...
    def _build_context_artifact(self, artifact: EngineeringDiscoveryModel, settings: Any = None) -> dict[str, Any]:
        """
        ...
        # Summary section
        summary = {
            "changed_files": len(artifact.change.changed_files) if hasattr(artifact.change, 'changed_files') else 0,
    ...
    def _build_discoveries(self, artifact: EngineeringDiscoveryModel) -> list[dict[str, Any]]:
        """
    ...
    def _get_affected_domains(self, artifact: EngineeringDiscoveryModel) -> list[str]:
        ...
        for behavior in artifact.get_behaviors():
            if hasattr(behavior, 'kind'):
                kind_str = str(behavior.kind.value if hasattr(behavior.kind, 'value') else behavior.kind)
    ...
    def _get_representative_paths(self, artifact: EngineeringDiscoveryModel) -> list[dict[str, Any]]:
