...
class JSONRenderer:
    ...
    def render(
        self, model: OperationalChangeModel | EngineeringDiscoveryModel
    ) -> dict[str, Any]:
        """
    ...
    def _render_change(self, change: Any) -> dict[str, Any]:
        ...
        return {
            ...
            "added_symbols": [
                self._render_symbol_summary(s) for s in change.added_symbols
            ],
            "removed_symbols": [
                self._render_symbol_summary(s) for s in change.removed_symbols
            ],
            "modified_symbols": [
                {
