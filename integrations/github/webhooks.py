...
class GitHubWebhookProvider(EventProvider):
    ...
    async def verify(self, payload: bytes, signature: str | None, secret: str | None) -> bool:
    ...
    async def _parse_pull_request(self, payload: dict[str, Any]) -> AnalysisRequest:
        ...
        return AnalysisRequest(
            ...
            metadata={"action": action, "installation_id": payload.get("installation", {}).get("id")},
        )
    ...
    async def _parse_installation(self, payload: dict[str, Any]) -> AnalysisRequest:
        ...
        Returns:
            AnalysisRequest object
        """
        repository = payload.get("repositories", [{}])[0] if payload.get("repositories") else {}
        ...
        return AnalysisRequest(
            ...
            metadata={"action": payload.get("action"), "installation_id": payload.get("installation", {}).get("id")},
        )