...
class NormalizationStage:
    ...
    def normalize(self, semantic_graph: dict[str, dict[str, Any]], language: str) -> dict[str, dict[str, Any]]:
        """
    ...
    def _normalize_entry_points(self, endpoints: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
    ...
    def _normalize_persistence_models(self, models: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
    ...
    def _normalize_test_definitions(self, tests: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
    ...
    def _normalize_event_constructs(self, events: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
    ...
    def _normalize_functions(self, functions: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
    ...
    def _normalize_classes(self, classes: list[dict[str, Any]], language: str) -> list[dict[str, Any]]:
        ...
        for cls in classes:
            ...
            if 'methods' in norm_cls:
                norm_cls['methods'] = self._normalize_functions(norm_cls['methods'], language)
